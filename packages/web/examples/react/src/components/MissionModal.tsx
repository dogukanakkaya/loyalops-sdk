...
import type { Mission, MissionSubmission } from "@loyalops/web";
import {
    useSubmitMission,
    useConnectPlatform,
} from "@loyalops/web";
                ...
                <div className="px-5 pb-5">
                    {showSuccess ? (
                        ...
                        <button
                            ...
                            className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold bg-indigo-500 hover:bg-indigo-600 text-white transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
